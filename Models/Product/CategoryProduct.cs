...
namespace MVCTest.Models.Product
{
    public class CategoryProduct
    {
        ...
        //Các category con
        public ICollection<CategoryProduct>? ChildrenCategories { get; set;}
        ...
        public void CategoryChildrenIds(ICollection<CategoryProduct> categoryChildren = null, List<int> lists = null)
        {
        ...
        public List<int> ParentCategoryIds(CategoryProduct category,List<int> lists)
        {
            if (category != null)
            {
