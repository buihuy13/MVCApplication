...
namespace MVCTest.Areas.Blog.Controllers
{
    [Area("Blog")]
    ...
    public class CategoriesController : Controller
    {
        ...
        {
            var categories = await (from c in _context.Categories select c).ToListAsync();
        ...
        public async Task<IActionResult> CreateAsync([Bind("ParentCategoryId", "Title", "Content", "Slug")] Category cate)
        {
        ...
        public IActionResult Delete(int? id)
        {
            ...
            var cate = _context.Categories.Where(c => c.Id == id).FirstOrDefault();
            if (cate == null)
            {
                return NotFound();
            }
        ...
        {
            var cate = await _context.Categories.Include(c => c.ChildrenCategories)
        ...
        public async Task<IActionResult> EditAsync(int? id)
        {
            ...
            var categories = await (from c in _context.Categories select c)
                                   .Include(c => c.ChildrenCategories)
        ...
        public bool checkValidParentCategory(Category cate, int? targetId)
        {
            if (cate.Id == targetId)
            { 
                return false;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditAsync([Bind("Title", "Content", "Slug", "ParentCategoryId")] Category newCate, int id)
        {
            var cate = await (from p in _context.Categories
                              where p.Id == id
